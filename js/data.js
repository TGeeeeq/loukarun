  ...
  const ENVS = [
    {
      ...
      props: ['sunflower', 'flower', 'beehive', 'signpost', 'butterflyZone', 'catnap', 'frogpond', 'cowboy', 'grazingcow', 'cheersquad'],
      particles: 'petals',
    },
    {
      ...
      sun: '#fff3b0', clouds: '#ffffff',
      props: ['appletree', 'ladder', 'basket', 'scarecrow', 'snail', 'cowboy', 'cheersquad'],
      particles: 'leaves',
    },
    {
      ...
      props: ['tree', 'mushroom', 'gnome', 'stump', 'owlbox', 'frogpond', 'snail', 'cheersquad'],
      particles: 'fireflies',
    },
    {
      ...
      sun: '#fff3b0', clouds: '#ffffff',
      props: ['cottage', 'fencebg', 'tractor', 'laundry', 'dovecote', 'catnap', 'cheersquad'],
      particles: 'none',
    },
    {
      ...
      props: ['haystack', 'sunflower', 'signpost', 'windmill', 'catnap', 'cowboy', 'grazingcow', 'farmhouse', 'cheersquad'],
      particles: 'petals',
    },
    {
