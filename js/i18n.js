...
const I18N = (() => {
  ...
  const STRINGS = {
    cs: {
      ...
      'premium.title': '⭐ Prémiové zvířátko',
      'premium.body': 'patří mezi prémiová zvířátka. V mobilní verzi hry půjde odemknout nákupem, který přímo podpoří azyl Nech mě růst.',
      'premium.demo': 'V této demo verzi si ho můžeš vyzkoušet zdarma. A jestli chceš azylu pomoct doopravdy, mrkni na <a href="https://nechmerust.org" target="_blank" rel="noopener">nechmerust.org</a>. 💚',
      'premium.unlock': 'Odemknout (demo)',
      'premium.close': 'Zavřít',
    ...
    en: {
      ...
      'premium.title': '⭐ Premium animal',
      'premium.body': 'is one of the premium animals. In the mobile version it can be unlocked with a purchase that directly supports the Nech mě růst sanctuary.',
      'premium.demo': 'In this demo version you can try them out for free. And if you’d like to help the sanctuary for real, check out <a href="https://nechmerust.org" target="_blank" rel="noopener">nechmerust.org</a>. 💚',
      'premium.unlock': 'Unlock (demo)',
      'premium.close': 'Close',
